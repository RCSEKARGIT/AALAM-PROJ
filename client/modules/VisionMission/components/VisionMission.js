            ...
            <div className="container">
               <div className="row">
                  <div id="home-content" className="column col-md-10 col-md-push-1 col-md-pull-1 col-xs-12 col-sm-12">
                     <h1>VISION</h1>
                     <p>Our vision is to enrich AALAM VILUTHUGAL ASSOCIATION member's life , through better connection, constant engagement ,continuous development and to lead a successful life in the society./</p>
                      <h1>MISSION</h1>
